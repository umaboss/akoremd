...
const ORBIT_ICONS = [
  <path key="0" d="M9 11l3 3L22 4M21 12v7a2 2 0 01-2 2H5a2 2 0 01-2-2V5a2 2 0 012-2h11" />,
...
export default function PayoutCycles() {
  ...
  return (
    <section className="sec band orbit-sec" id="payouts">
      <div className="wrap">
        ...
        <div className={`orbit-stage${active !== null ? ' has-active' : ''}`}>
          ...
          <div className="orbit-core">
            ...
            {active === null && (
              <p className="orbit-hint">Hover an icon to explore results</p>
            )}
          </div>
          ...
          <div className="orbit-icons">
            {cards.map((c, i) => (
              <button
                ...
                style={{ '--orbit-angle': `${ORBIT_ANGLES[i]}deg` }}
                aria-label={c.cn}
              ...
              >
                <span className="orbit-icon-inner">
                  ...
                  <span className="orbit-icon-label">{SPLITS[i]}</span>
                </span>
              </button>
            ))}
          </div>
